...
type selectionAlgorithm interface {
	...
	SelectBeacons(beacons []beacon.Beacon, resultSize int) []beacon.Beacon
}
...
func (a baseAlgo) SelectBeacons(beacons []beacon.Beacon, resultSize int) []beacon.Beacon {
...
func (baseAlgo) selectMostDiverse(beacons []beacon.Beacon, best beacon.Beacon) (beacon.Beacon, int) {
	if len(beacons) == 0 {
